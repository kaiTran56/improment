...
@EnableJpaRepositories(entityManagerFactoryRef = "secondEntityManagerFactory",
        ...
        basePackages = {"com.tranquyet.repository.second"})
public class SecondDBConfig {
    @Bean(name = "secondDataSource")
    @ConfigurationProperties(prefix = "spring.employee2.datasource")
    ...
    public LocalContainerEntityManagerFactoryBean entityManageFactory(EntityManagerFactoryBuilder builder,
        ...
        return builder.dataSource(dataSource)
                ...
                .packages("com.tranquyet.entity.second")
//                .persistenceUnit("SecondEmployeeEntity")
                .build();
    }
